...
const data = () => ({
  ...
  panel: [0],
  stepExpand:false,
  expandStyle:"border-radius:4px;background-color:white;box-shadow:0px 1px 5px #dfdfdf",
  arrowStyle:"position:absolute;right:0px;margin-right:20px;transform:rotate(0deg)",
  stepColor:'primary',
  fileValid:'',
  success:false,
  data: {},
